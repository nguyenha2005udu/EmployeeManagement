...
import com.example.testbackend1.dto.DepartmentDTO;
...
public class DepartmentController {
    ...
    @PutMapping("/{code}")
    public ResponseEntity<Department> updateDepartment(@PathVariable String code, @RequestBody Department department) {
